...
## 2. 如果以前装过旧版本，先删除旧链接
如果你之前已经安装过旧版3사6조，请先检查并删除这些目录里的旧 `data` / `scripts` 链接：

```text
C:\Users\<YOUR_USER>\.openclaw\workspace-seja
C:\Users\<YOUR_USER>\.openclaw\workspace-hongmungwan
C:\Users\<YOUR_USER>\.openclaw\workspace-saganwon
C:\Users\<YOUR_USER>\.openclaw\workspace-seungjeongwon
C:\Users\<YOUR_USER>\.openclaw\workspace-hojo
C:\Users\<YOUR_USER>\.openclaw\workspace-yejo
C:\Users\<YOUR_USER>\.openclaw\workspace-byeongjo
C:\Users\<YOUR_USER>\.openclaw\workspace-hyeongjo
C:\Users\<YOUR_USER>\.openclaw\workspace-gongjo
C:\Users\<YOUR_USER>\.openclaw\workspace-yejo_hr
C:\Users\<YOUR_USER>\.openclaw\workspace-jobocheong
```
...
在部分环境里，安装脚本可能没有把3사6조的 agent 配置完整落进 `openclaw.json`。
