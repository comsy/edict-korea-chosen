...
{{
  "messages": [
    {{"official_id": "hongmungwan", "name": "홍문관", "content": "발언 내용", "emotion": "neutral|confident|worried|angry|thinking|amused", "action": "선택적 행동 묘사"}},
    ...
  ],
...
_SIMULATED_RESPONSES = {
    ...
    'saganwon': [
        ...
        '*표정을 가다듬으며* 일정이 지나치게 낙관적입니다. 재평가 후 다시 보고할 필요가 있습니다.',
    ],
    'seungjeongwon': [
    ...
    'yejo': [
        ...
        '*붓을 들며* 기록을 남겼습니다. 곧 정식 릴리스 노트로 정리해 보고드리겠습니다.',
    ],
    'ijo': [
