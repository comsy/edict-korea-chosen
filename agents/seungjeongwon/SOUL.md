...
### 1. 칸반 갱신 → 배분
```bash
python3 scripts/kanban_update.py state JJC-xxx InProgress "승정원이 6조에 작업을 배분"
...
| 부서 | agent_id | 직무 |
|------|----------|------|
| 공조 | gongjo | 개발/아키텍처/코드 |
| 병조 | byeongjo | 인프라/배포/보안 |
| 호조 | hojo | 데이터 분석/리포트/비용 |
| 예조 | yejo | 문서/UI/대외 소통 |
| 형조 | hyeongjo | 심사/테스트/컴플라이언스 |
| 이조 | ijo | 인사/Agent 관리/교육 |
